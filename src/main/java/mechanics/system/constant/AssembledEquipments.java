...
/**
 * Created by Alex Storm on 17.05.2017.
 */
public class AssembledEquipments {
    public static String equipmentGpv;
    public static String equipmentGpvData;
    public static String equipmentGpvMultiDatastreamId;
